...
<br/>I had the opportunity to work in Romania as a Frontend Developer for a year for Harte Hanks. During this period, we collaborated with important clients such as Dove, Booking and Takeda, the most important being IBM. I have been recognized for my UX and UI skills, bringing value to projects by applying innovative concepts and creating an intuitive user interface. I had a significant impact on clients projects, particularly for IBM, where I helped improve user experience and increase application performance. A notable achievement was the development of an application used by the DEERT team from IBM for sorting and correcting data inserted through an excel document or through certain databases. I was also involved in the development of an application used internally, used by managers and team leaders to improve the efficiency of employees' working time. During the working period, I gained solid knowledge both in the frontend, working with technologies such as JavaScript, React, Next.js, Tailwind ,TypeScript, React Testing, and many other libraries, and in the backend, working with Express.js and databases such as PostgreSQL.</div>
            </div>
