...
const Journey = () => {
  ...
  return (
    <div ref={ref}  className='w-full min-h-[100vh] md:min-h-[800px]'>
        <div className="w-[70%] relative mx-auto z-[170] text-white md:w-full md:mx-0 md:border-0   md:min-h-[800px] md:bg-mobileShadowBg md:rounded-none bg-shadowBg border-[1px] rounded-[0.5rem] p-[3rem] md:p-0 ">
          <div className="md:w-[70%] xsm:w-[90%] md:mx-auto xsm:mx-[2rem]">
            <h2 className="text-[2.3rem] lg:text-[1.6rem]">My journey through the universe </h2>
            <div className="text-[1.1rem] lg:text-[1rem] text leading-7 pt-[2rem] md:pb-[2rem]">
